In the first task  Check if a Number is Even or Odd,
the user reads an integer value with the help of input function
By using the if condition and n % 2==0 to check wheather the given number is even or odd
if the condition is true the the given number is even otherwise the given number is false.
